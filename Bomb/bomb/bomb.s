...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp // 栈指针值 - 8
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi  //esi 指第二个参数
...
0000000000400efc <phase_2>:                   //输入一个存在了 rdi
  400efc:	55                   	push   %rbp   //
  400efd:	53                   	push   %rbx   //被调用者保存的两个寄存器
  400efe:	48 83 ec 28          	sub    $0x28,%rsp //栈指针-40 bytes, 开辟了四十个字节的空间
  400f02:	48 89 e6             	mov    %rsp,%rsi  //第二个参数 定为 rsp
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers> 
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)  //栈指针间接寻址 比较双字
  400f0e:	74 20                	je     400f30 <phase_2+0x34>  //equal then jump400f30
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax  //rbx - 4-> eax 在此处循环，取出之前的rbx*2
  400f1a:	01 c0                	add    %eax,%eax      //eax=eax*2
  400f1c:	39 03                	cmp    %eax,(%rbx)    //
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx //rbx+4->rbx 
  400f29:	48 39 eb             	cmp    %rbp,%rbx  //  这句话是关键，rbx 和 rbp 都有什么用都存 了什么
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx   //rsp+4地址放入rbx
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp  // rsp +24  rbp存了个地址rsp+24的地址
...
0000000000400f43 <phase_3>:
  400f43:	48 83 ec 18          	sub    $0x18,%rsp // allocate 24 bytes memory
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx //rcx =rsp + 12  第四个参数
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx // rdx = rsp + 8 第三个参数 --应该就存了输入进去的两个数
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi // %esi 存放第二个参数 “%d %d” 输入两个整数
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax      //itialize eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt> //sscanf又来了
  400f60:	83 f8 01             	cmp    $0x1,%eax        //返回值与1比 输入数字必须大于1
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>    //jump
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)            //7 与 (rsp +8) 比较双字
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>    //无符号大于跳转
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax           //小于7 赋值到eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)       // 跳转 0x402470 值为 *(0x402470 +rax *8)
  ...
  400fad:	e8 88 04 00 00       	callq  40143a <explode_bomb>  //直接爆炸
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax         //本题应该算一道计算题
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>  //相等则不会爆炸
  400fc4:	e8 71 04 00 00       	callq  40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp
  400fcd:	c3                   	retq   

0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp        //栈拓展8个字节
  400fd2:	89 d0                	mov    %edx,%eax        //eax 赋值 14
  400fd4:	29 f0                	sub    %esi,%eax        //eax =eax -0
  400fd6:	89 c1                	mov    %eax,%ecx        //ecx 赋值eax
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx       //逻辑右移 右移 31位？？？？
  400fdb:	01 c8                	add    %ecx,%eax        //eax赋值ecx   0？
  400fdd:	d1 f8                	sar    %eax               //算式右移 除以2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx   //ecx =(%rax+rsi)   7 第二轮 为8+3 =11.. 8+1=9.. 8+0=8
  400fe2:	39 f9                	cmp    %edi,%ecx          // 7 - 第一个输入 
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>  // 小于等于跳转  若输入大于等于7跳转，若输入小于7则继续
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx    //    edx 为 rcx - 1 
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>         //  
  400fee:	01 c0                	add    %eax,%eax            //    
  400ff0:	eb 15                	jmp    401007 <func4+0x39>    //
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax              //  eax = 0
  400ff7:	39 f9                	cmp    %edi,%ecx              //  ecx edi再比较  
  400ff9:	7d 0c                	jge    401007 <func4+0x39>      //ecx >= edi 大于等于跳转（第一轮 edi<=7 &&edi>=7）
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi         //  esi 值为 rcx+1 8（因为寄存器值不是地址，就是个数字）
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>         //这个不是跳转，是调用函数，所以只要到这就必然爆炸
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax    // 2*rax + 1 -->>eax
  401007:	48 83 c4 08          	add    $0x8,%rsp              // 恢复栈
  40100b:	c3                   	retq   

000000000040100c <phase_4>:
  40100c:	48 83 ec 18          	sub    $0x18,%rsp           //拓展 24 bytes
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx       //12+rsp  第四个参数rcx
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx       //8+rsp   第三个参数rdx
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi       //  第二个参数"%d %d"
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax            //  initialize the eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax               //2 与 eax比较
  40102c:	75 07                	jne    401035 <phase_4+0x29>   // 不相等 bomb
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)         //比较四字， 14 与 输入第一个数字
  401033:	76 05                	jbe    40103a <phase_4+0x2e>    // <=跳转 ，否则 bomb
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>    
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx              // 第三个参数 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                //第二个参数 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi           //第一个参数 输入的第一个数
  401048:	e8 81 ff ff ff       	callq  400fce <func4>           //总之 eax存了个地址
  40104d:	85 c0                	test   %eax,%eax                //eax值 不等于0 就bomb
  40104f:	75 07                	jne    401058 <phase_4+0x4c>     //
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)           //(rsp+c) -0 第二个输入要等于 0
  401056:	74 05                	je     40105d <phase_4+0x51>      // 等于 0
...
0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx               
  401063:	48 83 ec 20          	sub    $0x20,%rsp          拓展32字节
  401067:	48 89 fb             	mov    %rdi,%rbx          将第一个参数，也就是输入传入rbx
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax      段寄存器+0x28-->rax
  401071:	00 00                                         
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)    rax-->24+rsp
  401078:	31 c0                	xor    %eax,%eax            eax-->0
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length> 
  40107f:	83 f8 06             	cmp    $0x6,%eax            //长度与6比
  401082:	74 4e                	je     4010d2 <phase_5+0x70>  //  不相等就炸
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx   //ecx=rax+rbx =0 +rbx rbx里放的就是输入字符串取一个字符放入，例如 
  40108f:	88 0c 24             	mov    %cl,(%rsp)       //rcx低位 ->rsp     //a 开头 ecx =97
  401092:	48 8b 14 24          	mov    (%rsp),%rdx    //step再给rdx
  401096:	83 e2 0f             	and    $0xf,%edx        //1111&edx 后四位有几个1
  maduiersnfotvbylSo you think you can stop the bomb with ctrl-c, do you?
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx    // 取了上面那句话第二个字符
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)  //rdx低位-》
  4010a4:	48 83 c0 01          	add    $0x1,%rax                //rax+1
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax                //与6比
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>    //不相等跳转
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)          //
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi            //esi
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi          //与rdi
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal> //比较
  4010c2:	85 c0                	test   %eax,%eax                  //
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>      //相等不炸
...
00000000004010f4 <phase_6>:
  ...
  4010fa:	55                   	push   %rbp               
  4010fb:	53                   	push   %rbx             
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp          //80 bytes
  401100:	49 89 e5             	mov    %rsp,%r13            //r13 存rsp的地址
  401103:	48 89 e6             	mov    %rsp,%rsi            //rsi 第二个参数
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>     //与phase2同理 六个数存在 rsp rsp +4 .....rsp+20
  40110b:	49 89 e6             	mov    %rsp,%r14              //         r14 装了 2000 0001
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d             //r12 initialize
  401114:	4c 89 ed             	mov    %r13,%rbp              //  rbp 里装的是 1
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax         //这是第一个存的数 ，
  40111b:	83 e8 01             	sub    $0x1,%eax              //eax -1
  40111e:	83 f8 05             	cmp    $0x5,%eax               //
  401121:	76 05                	jbe    401128 <phase_6+0x34>   // 小于等于跳 第一个输入小于等于5
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>    //炸
  401128:	41 83 c4 01          	add    $0x1,%r12d               // r12d +1 =1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d               //
  401130:	74 21                	je     401153 <phase_6+0x5f>     //相等跳 结束双重循环
  401132:	44 89 e3             	mov    %r12d,%ebx                //ebx ->1
  401135:	48 63 c3             	movslq %ebx,%rax                //低位赋值给rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax       //eax = (rsp + rax*4) 取第二个数
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)           //eax 第二个数 需要和 rbp 不相等
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx                //ebx =2
  401148:	83 fb 05             	cmp    $0x5,%ebx                 //ebx与5比较
  40114b:	7e e8                	jle    401135 <phase_6+0x41>      //小于五则跳回去 ，ebx记录第几次，找第几个数字，--》直到第六个数字
  40114d:	49 83 c5 04          	add    $0x4,%r13                  //给r13地址+4 r13装的原来是第一个数字，现在是第二个数
  401151:	eb c1                	jmp    401114 <phase_6+0x20>      //
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi      //双重循环结束：将 24+rsp 存入rsi
  401158:	4c 89 f0             	mov    %r14,%rax            //  存地址 输入第一个数的地址
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx            //   
  401160:	89 ca                	mov    %ecx,%edx            // edx=7
  401162:	2b 10                	sub    (%rax),%edx          //edx减去rax  
  401164:	89 10                	mov    %edx,(%rax)            //把他存到了rsp 那个地址
  401166:	48 83 c0 04          	add    $0x4,%rax              //rax地址偏移4位      取出数x 7-x再存回去
  40116a:	48 39 f0             	cmp    %rsi,%rax              //rsi存放最后一个数的地址
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>  //不相等跳
  40116f:	be 00 00 00 00       	mov    $0x0,%esi              //esi-.0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>    
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx         //从后面跳回来
  40117a:	83 c0 01             	add    $0x1,%eax              //eax =1+1
  40117d:	39 c8                	cmp    %ecx,%eax              //ecx =6 
  40117f:	75 f5                	jne    401176 <phase_6+0x82>    //不相等跳
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx             
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) 第一次rsi为0
  40118d:	48 83 c6 04          	add    $0x4,%rsi              //rsi+4
  401191:	48 83 fe 18          	cmp    $0x18,%rsi             //24 ==esi??
  401195:	74 14                	je     4011ab <phase_6+0xb7>    
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx   //rsi*1+rsp  
  40119a:	83 f9 01             	cmp    $0x1,%ecx            //ecx和1比
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>  //大于等于
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax               //
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx         //edx赋值0x6032d0 地址里放了 76 0x6032e0放了-88 f0-》-100，300-》-77，310-》-35 320-》-69，330-》0
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>    //
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx          //给rbx赋值0x603320 6304544
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax          //rax
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi
  4011ba:	48 89 d9             	mov    %rbx,%rcx            
  4011bd:	48 8b 10             	mov    (%rax),%rdx          
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)
  4011c4:	48 83 c0 08          	add    $0x8,%rax
  4011c8:	48 39 f0             	cmp    %rsi,%rax            rsi 4203024 rax6304512
  ...
  4011e5:	39 03                	cmp    %eax,(%rbx)    前一个节点低四位大于后一个节点
...
000000000040131b <string_length>:
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi)    一个byte一个byte比较？？
  40131e:	74 12                	je     401332 <string_length+0x17>  //相等跳出
  401320:	48 89 fa             	mov    %rdi,%rdx          //
  401323:	48 83 c2 01          	add    $0x1,%rdx          //rdx+1
  401327:	89 d0                	mov    %edx,%eax          //
  401329:	29 f8                	sub    %edi,%eax          //
  40132b:	80 3a 00             	cmpb   $0x0,(%rdx)        //（rdx）==0就结束函数
...
000000000040145c <read_six_numbers>:    //rsi 为第二个参数
  40145c:	48 83 ec 18          	sub    $0x18,%rsp //站寄存器 -0x18 栈顶增加了24字节 
  401460:	48 89 f2             	mov    %rsi,%rdx  //rdx 赋值 rsi
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx // 4+rsi -> rcx
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax //20+rsi -> rax
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)  // 栈顶+8存rax(rsi+20)
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax // 16+rsi->rax
  401474:	48 89 04 24          	mov    %rax,(%rsp)    //  栈顶存(存8字节) rsi+16
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9  //  12+rsi ->r9
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8  //  8->rsi->r8
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi //  将地址的值给esi(rsi 低八位)
  401485:	b8 00 00 00 00       	mov    $0x0,%eax      // 0->eax
  40148a:	e8 61 f7 ff ff       	callq  400bf0 <__isoc99_sscanf@plt> //看不懂
  40148f:	83 f8 05             	cmp    $0x5,%eax                    //eax是返回值，eax-5
  401492:	7f 05                	jg     401499 <read_six_numbers+0x3d> //大于跳转 eax>5跳转 确保有至少六个数字
  401494:	e8 a1 ff ff ff       	callq  40143a <explode_bomb>          //引爆
  401499:	48 83 c4 18          	add    $0x18,%rsp           ///   栈还原
  40149d:	c3                   	retq   
...
000000000040149e <read_line>:
  ...
  4014af:	75 6e                	jne    40151f <read_line+0x81> // 非零
